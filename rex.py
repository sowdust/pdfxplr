...
RE_USERNAME_WINDOWS = re.compile(r'[A-Z]:\\(?:users|utenti)\\(.*?)\\', re.IGNORECASE)
RE_USERNAME_LINUX = re.compile(r'.*?/home/([^/]+).*?', re.IGNORECASE)
RE_USERNAME_MAC = re.compile(r'/users/([^/]+).*?', re.IGNORECASE)
